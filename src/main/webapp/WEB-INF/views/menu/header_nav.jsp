...
<body>
    <header id="header">
        <div id="header_box">
            <div id="logo">
                <h1>
                    <a href="/website"> <img src="/website/assets/img/main_logo.png">
                    </a>
                </h1>
            </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="/website/board/business">BUSINESS Q&A</a></li>
                            <li><a href="/website/board/product">PRODDUCT Q&A</a></li>
