...
public class BoardController {
	...
	public String getBoardList(@PathVariable("catName") String catName,
			...
			@RequestParam(name = "searchKey", required = false) String key,
			@RequestParam(name = "searchValue", required = false) String value, HttpSession session, ModelMap model) {
	...
	public String getBoardItem(@PathVariable("boardNo") int boardNo, HttpServletRequest req, ModelMap model) {
		BoardDto boardItem = boardService.getBoardItem(boardNo);
	...
	@GetMapping(value = { "/{boardNo}/delete" })
