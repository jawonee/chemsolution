...
public class DaoSqls {
	...
	public static final String SELECT_BOARD_ITEM = "select board.id, member_id, subject, content, category_id ,create_date, category.name as category_name from board join category on board.category_id = category.id and board.id =:boardNo";
